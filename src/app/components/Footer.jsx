...
const Footer = () => {
  return (
    <div className="grid grid-cols-[minmax(20px,0.2fr)_1fr_minmax(20px,0.2fr)] bg-[#252525]">
    <section className="col-start-2 text-[#8F8997] flex flex-col lg:flex-row justify-between gap-10 px-6 sm:px-10 lg:px-5 py-10 w-full text-center lg:text-left">
